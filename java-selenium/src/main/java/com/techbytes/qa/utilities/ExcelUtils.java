...
public class ExcelUtils {
    ...
    public static List<Map<String, String>> readExcel(String path, String sheetName) {
        ...
        try (
                InputStream is = ExcelUtils.class.getClassLoader().getResourceAsStream(path); Workbook workbook = WorkbookFactory.create(is)) {
            ...
            logger.info(" -> Excel rows loaded: {}", data.size());
            return data;

        } catch (Exception e) {
            logger.error(" -> Failed to read Excel: " + path, e);
